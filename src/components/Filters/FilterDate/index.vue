<template>
  <div class="zpl-filter-date">
    ...
    <Textfield v-if="date === 'TODAY'" v-model="model" suffix-icon="Calendar" disabled class="today" />
    <div
    ...
    >
      <div class="range-input">
        ...
        <Textfield v-model="model[0]" suffix-icon="Calendar" disabled />
      </div>
      <div class="range-input">
        <label>{{ $t('date.end') }}</label>
        <Textfield v-model="model[1]" suffix-icon="Calendar" disabled />
      </div>
    </div>
