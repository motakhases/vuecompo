<template>
  <div :class="['zpl-avatar-upload', size]">
    <vue2Dropzone
      ...
      id="dropzone"
    >
      <Thumbnail icon="terminal" size="large" :img="imgRef ? imgRef : null" />
      <!-- if there is no image -->
      <button v-if="!imgRef" class="zpl-avatar-upload-button">
        <Icon name="Cloud" />
      </button>
    </vue2Dropzone>
    <!-- if there is an image -->
    <Dropdown :list="dropList" width="200px" v-if="imgRef">
