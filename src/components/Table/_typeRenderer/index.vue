<template>
  ...
  >
    ...
    <div v-if="data.type === 'custom'" class="custom">
      <div
        v-if="data.data.image || data.data.image === '' || data.data.logo || data.data.icon || data.data.pspLogo"
        class="image"
      >
        <Thumbnail :icon="data.data.icon" :img="data.data.image" :logo="data.data.logo" :pspLogo="data.data.pspLogo" />
      </div>
      <div class="image" v-else-if="data.data.avatarImage || data.data.avatarImage === ''">
        <Avatar size="medium" :img="data.data.avatarImage" />
      </div>
      <div class="text">
        <span
          :class="['title', { 'td-disable': data.disable, 'font-Mono': data.data.titleMono }, data.data.titleClasses]"
        >
          {{ data.data.title }}
        </span>
        <small :class="['sub', { 'td-disable': data.disable, 'font-Mono': data.data.subMono }, data.data.subClasses]">
          {{ data.data.sub }}
        </small>
      </div>
    </div>
    ...
    <!--------------
          Date
    -------------->
    <div v-else-if="data.type === 'date'" :class="['date', { 'td-disable': data.disable }]">
    ...
    <div
      ...
      :class="['description', { 'td-disable': data.disable, 'font-Mono': data.mono }, data.classes]"
    >
      {{ data.data }}
    </div>
  </component>
